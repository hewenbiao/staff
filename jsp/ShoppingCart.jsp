...
<!-- saved from url=(0029)#flow.php -->
<html xmlns="http://www.w3.org/1999/xhtml">
<head>

<title>购物车</title>

<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/statics/css/wrzc_common.css">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/statics/css/flow.css">
<script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/jquery-1.9.1.min.js"></script>
<script>
var pay_balance_id =null ;//保存余额支付的id做为js全局变量
</script>
<script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/jquery.json.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/transport.js">
</script><script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/common.js">
</script><script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/shopping_flow.js">
</script><script src="${pageContext.request.contextPath}/statics/js/tp.php"></script>
</head>
...
<div id="site-nav">
  <div class="sn-container w1210"> 
    ...
    <font id="login-info" class="sn-login-info"><a class="sn-login main-color" href="" target="_top">yiren</a><em>欢迎您回来！</em>
<a class="sn-register" href="" target="_top">退出</a> 
</font>
    <ul class="sn-quick-menu">
      <li class="sn-mytaobao menu-item">
        <div class="sn-menu"> 
          <a class="menu-hd" href="" target="_top" rel="nofollow">我的信息<b></b></a>
          <div id="menu-2" class="menu-bd">
            <div class="menu-bd-panel"> 
            	<a href="" target="_top" rel="nofollow">已买到的宝贝</a> 
                <a href="" target="_top" rel="nofollow">我的地址管理</a> 
            </div>
          </div>
        </div>
      </li>
      ...
      <li class="sn-cart mini-cart menu"> 
        <a id="mc-menu-hd" class="sn-cart header-icon main-color" href="" target="_top" rel="nofollow"><i></i>购物车</a> 
      </li>
      <li class="sn-favorite menu-item">
        <div class="sn-menu"> 
          <a class="menu-hd" href="h" target="_top" rel="nofollow">收藏夹<b></b></a>
      ...
      <li class="sn-favorite menu-item">
        <div class="sn-menu"> 
          <a class="menu-hd" href="" target="_top" rel="nofollow">卖家中心<b></b></a>
          <div id="menu-4" class="menu-bd">
            <div class="menu-bd-panel"> 
            	<a href="" target="_top" rel="nofollow">商家入驻</a> 
                <a href="" target="_top" rel="nofollow">商家中心</a> 
            </div>
          </div>
        </div>
      </li>
          ...
          <div class="menu-bd sn-qrcode" id="menu-5">
           <ul>
            <li class="app_down">
			  ...
			  <p>微信商城</p>
              <img src="${pageContext.request.contextPath}/statics/images/app.jpg" alt="请用手机浏览器扫描" width="86px" height="240px">               
            </li>                    
          </ul>
          </div>
        </div>

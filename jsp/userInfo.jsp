								...
								<table width="100%" border="0" cellpadding="10" cellspacing="1" bgcolor="#eeeeee">
									...
									<tr>
										<td width="28%" align="right">
											<font class="main-color">*</font>真实姓名：</td>
									...
									<tr>
										<td align="right">
											<font class="main-color">*</font>身份证号：</td>
									...
									<tr>
										<td align="right">
											<font class="main-color">*</font>身份证证件照：</td>
										<td align="left">正面：
									...
									<tr>
										...
										<td align="left"><input type="text" name="address" value="" class="inputBg" />
											<div class="required-notice"><i class="notice-icon"></i><span class="notice-text address-detail-notice"></span></div>
										</td>
									</tr>
									<tr>

...
insert  into `back_user`(`id`,`backUserName`,`roleId`,`backPassWord`) values (1,'youhu',1,'123456'),(2,'admin',2,'888888');
...
insert  into `delivery_status`(`id`,`deliveryStatus`) values (1,'未发货'),(2,'已发货'),(3,'已收货');
...
/*Table structure for table `evaluate_static` */

DROP TABLE IF EXISTS `evaluate_static`;

CREATE TABLE `evaluate_static` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `evaluateStaticName` varchar(20) DEFAULT NULL COMMENT '评价状态名称',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

/*Data for the table `evaluate_static` */

insert  into `evaluate_static`(`id`,`evaluateStaticName`) values (1,'未评价'),(2,'已评价');
...
/*Table structure for table `ju_back_name` */

DROP TABLE IF EXISTS `ju_back_name`;

CREATE TABLE `ju_back_name` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `backLoginName` varchar(20) NOT NULL COMMENT '用户登录名称',
  `juId` int(11) NOT NULL COMMENT '权限名称id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

/*Data for the table `ju_back_name` */

insert  into `ju_back_name`(`id`,`backLoginName`,`juId`) values (1,'admin',1),(2,'admin',2),(3,'admin',3),(4,'admin',4);
...
CREATE TABLE `jurisdiction` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `juName` varchar(30) NOT NULL COMMENT '权限名称',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

/*Data for the table `jurisdiction` */

insert  into `jurisdiction`(`id`,`juName`) values (1,'admin:select'),(2,'admin:insert'),(3,'admin:update'),(4,'admin:delete');
...
CREATE TABLE `order` (
  ...
  `deliveryStatusId` int(2) DEFAULT '1' COMMENT '发货状态id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8;

/*Data for the table `order` */

insert  into `order`(`id`,`userId`,`userAddressId`,`createTime`,`cost`,`serialNumber`,`deliveryTimeId`,`paymentStatusId`,`paymentWayId`,`distributionWayId`,`userTiscountCouponId`,`invoiceTypeId`,`invoiceContentId`,`leaveWord`,`deliveryStatusId`) values (1,1,2,'2018-07-12 11:59:50',5210.00,'64336CEA93C94FC3A7FD00D07E79FF0F',2,1,2,1,2,2,2,'好处',1),(2,1,1,'2018-07-12 23:13:15',9854.00,'D7F9064ACD8F443CA7DEA0AC743695C8',2,1,2,1,1,1,1,'我要优惠',1),(3,1,2,'2018-07-13 17:24:32',2230.00,'5337172976184CDF910469E66075D3E7',1,2,2,1,0,0,0,'',1),(4,1,2,'2018-07-13 18:01:13',2383.00,'1D5A354F5B9C4BC2B6139A89D24B4782',2,1,1,1,0,0,0,'',1),(5,1,1,'2018-07-14 18:46:15',6073.00,'895104E992D245008E6227B437FB1E09',1,2,1,1,0,1,5,'',1),(6,1,1,'2018-07-14 19:31:13',184.00,'AF7CD10E25374D0F9CFCCFC232F5F0E1',3,2,1,1,0,0,0,'',1),(7,1,1,'2018-07-14 19:34:16',264.00,'2C6A02DF1F17462695CA285B58732D79',3,1,1,1,0,0,0,'',1),(8,1,1,'2018-07-14 20:14:30',244.00,'0858C1AAFA4F480BA10EF8FFAC19AB9F',3,1,1,1,0,0,0,'',1),(9,1,1,'2018-07-14 20:37:11',503.00,'C8C56C8A06EA4B9F8DFD895BA82D61AE',3,1,1,1,0,0,0,'',1),(10,1,1,'2018-07-14 20:39:47',3230.00,'23E0123A87DB4ECAAEDA2B045C86FF20',3,1,1,1,0,0,0,'',1),(11,1,1,'2018-07-14 20:44:54',3230.00,'EF6CE9818586443CBA383D44FD744918',3,2,1,1,0,0,0,'',1),(12,1,2,'2018-07-15 14:30:54',4873.00,'126185CBC9D8487DBC63B0F728D2771F',2,2,2,1,0,0,0,'',1),(13,1,2,'2018-07-16 19:06:59',3230.00,'889D425D6C904AA9B0E641E3AE9444EB',2,2,1,1,0,0,0,'',1),(14,2,4,'2018-07-17 15:43:16',3822.00,'C0719F0694D14EA2A7612C79B8A386B7',2,1,1,1,0,0,0,'',1),(15,2,4,'2018-07-17 15:45:15',3822.00,'CA9B17B888AE4FFCB67A1FEF636629FB',2,1,1,1,0,0,0,'',1),(16,2,4,'2018-07-17 16:04:06',551.00,'917E21538B4D424CA11B71CB528ED5F9',2,2,1,1,0,0,0,'',1),(17,2,4,'2018-07-17 16:08:23',353.00,'5CD890CBED634FADAD3ED1AB84BF810D',1,2,2,1,0,0,0,'',1),(18,2,4,'2018-07-20 13:47:14',543.00,'E3F4BE00F92340A4A2B05DAAAAE713DB',2,1,2,1,0,0,0,'',1),(19,2,4,'2018-07-26 11:45:20',114.00,'392A60EBA8EC4F41963782A11296956A',2,1,1,1,0,0,0,'鱼护',1),(20,2,4,'2018-07-26 11:48:56',465.00,'DD0886EE767C49CDA66AEA4E927953BD',2,2,1,1,0,0,0,'是是是',1),(21,2,4,'2018-07-28 13:22:10',114.00,'78A06FFF67FF43AC9B708BEC3D963465',2,2,1,1,0,0,0,'',1),(22,2,4,'2018-07-28 13:26:41',196.00,'C7738082D08C43B7AA36BA27F5469F2F',3,2,1,1,0,0,0,'',1),(23,1,1,'2018-07-30 15:30:27',384.00,'2EAEFF3E66CD49748995324E5A5C985C',1,1,2,1,1,0,0,'',1),(24,1,1,'2018-07-30 15:39:31',184.50,'4A424B2381204D7F8F3C27162C48CE32',1,1,2,1,1,0,0,'',1),(25,2,4,'2018-08-03 16:23:23',345.00,'0EC63AF945CA4B4F98B348FD671427F2',2,1,1,1,0,0,0,'',1),(26,2,4,'2018-08-03 16:25:02',184.00,'927FA3F97B02462E9A7926942D6EBCFC',2,2,1,1,0,0,0,'',1),(27,2,4,'2018-08-03 21:16:58',424.00,'A764712DD9BF487A9BF41D4181C18E37',3,1,2,1,0,0,0,'',1),(28,1,1,'2018-08-08 23:10:10',24.00,'73F1F37946BB4A6484C431DC23D40073',2,2,2,1,0,0,0,'',1),(29,7,5,'2018-08-09 15:16:23',3230.00,'E38750EB5C5E4EB196EB3F590261F9CF',2,2,1,1,0,0,0,'',1),(30,7,5,'2018-08-09 15:21:05',174.00,'B15BFFEE7BA54C80B46AC64ABD4F1222',2,1,2,1,0,0,0,'',1);
...
CREATE TABLE `order_detail` (
  ...
  `evaluateStaticId` int(2) DEFAULT '1' COMMENT '评价状态id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8;

/*Data for the table `order_detail` */

insert  into `order_detail`(`id`,`orderId`,`productId`,`quantity`,`cost`,`evaluateStaticId`) values (1,2,736,1,9699.0,1),(2,2,794,1,180.0,1),(3,3,716,1,2245.0,1),(4,4,740,1,2398.0,1),(5,5,739,1,6088.0,1),(6,6,768,1,199.0,1),(7,7,769,1,279.0,1),(8,8,774,1,259.0,1),(9,9,774,2,518.0,1),(10,10,714,1,3245.0,1),(11,11,714,1,3245.0,2),(12,12,741,1,4888.0,1),(13,13,715,1,3245.0,2),(14,14,735,1,3837.0,1),(15,15,735,1,3837.0,1),(16,16,770,1,368.0,1),(17,16,771,1,198.0,1),(18,17,770,1,368.0,1),(19,18,773,1,299.0,1),(20,18,774,1,259.0,1),(21,19,797,1,129.0,1),(22,20,799,1,480.0,1),(23,21,815,1,129.0,1),(24,22,840,1,211.0,1),(25,23,754,1,399.0,1),(26,24,818,1,10.5,1),(27,24,753,1,189.0,1),(28,25,794,2,360.0,1),(29,26,768,1,199.0,1),(30,27,774,1,259.0,1),(31,27,794,1,180.0,1),(32,28,821,1,39.0,1),(33,29,710,1,3245.0,2),(34,30,753,1,189.0,1);
...
CREATE TABLE `user` (
  ...
  `birthday` date DEFAULT '2000-00-00' COMMENT '出生时间',
  `headPortrait` varchar(255) DEFAULT '15337865673232920a50054d51812eb88a64ed2e06c1d.jpg' COMMENT '头像文件',
...
insert  into `user`(`id`,`userName`,`password`,`phone`,`sex`,`birthday`,`headPortrait`,`email`) values (1,'admin','e10adc3949ba59abbe56e057f20f883e','13422952290',1,'1989-02-02','15336196862062920a50054d51812eb88a64ed2e06c1d.jpg','940354330@qq.com'),(2,'sad1','e10adc3949ba59abbe56e057f20f883e','13422953190',1,'2018-07-11','153328483490986d611f634addf003b123bbf3b60d2e2.jpg','940354330@qq.com'),(3,'wqe','e10adc3949ba59abbe56e057f20f883e',NULL,1,NULL,'15337865673232920a50054d51812eb88a64ed2e06c1d.jpg',NULL),(4,'ew','e10adc3949ba59abbe56e057f20f883e',NULL,1,NULL,'15337865673232920a50054d51812eb88a64ed2e06c1d.jpg',NULL),(5,'dd','e10adc3949ba59abbe56e057f20f883e',NULL,1,NULL,'15337865673232920a50054d51812eb88a64ed2e06c1d.jpg',NULL),(6,'v2018847540','fcea920f7412b5da7be0cf42b8c93759','13422953190',1,NULL,'15337865673232920a50054d51812eb88a64ed2e06c1d.jpg',NULL),(7,'v2018895400','e10adc3949ba59abbe56e057f20f883e','13534022050',0,'1994-07-12','153379917594886d611f634addf003b123bbf3b60d2e2.jpg','736259432@qq.com');
...
insert  into `user_address`(`id`,`userId`,`consignee`,`address`,`addressPhone`,`postcode`,`isDefault`) values (1,1,'阿铭','北京-北京-东城区','18234256475',100000,1),(2,1,'龙儿-护','安徽-安庆-大观区','15582412512',246000,0),(4,2,'糊糊','天津-蝴蝶-北街','13245784587',12451,0),(5,7,'吴颖琪','向南村32号','18576486452',518000,0);
...
insert  into `user_commodity`(`id`,`userId`,`productId`) values (1,2,736);
...
insert  into `user_discount_coupon`(`id`,`userId`,`dcId`,`dcsId`) values (1,1,1,3),(2,1,2,1),(3,1,3,1);
...
insert  into `user_integral`(`id`,`userId`,`integral`) values (1,2,380),(2,1,24),(3,7,3230);
...
/*Table structure for table `user_product_evaluate` */

DROP TABLE IF EXISTS `user_product_evaluate`;

CREATE TABLE `user_product_evaluate` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `userId` int(11) DEFAULT NULL COMMENT '用户id',
  `productId` int(11) DEFAULT NULL COMMENT '商品id',
  `uPEName` varchar(255) DEFAULT NULL COMMENT '用户商品评价',
  `evaluateTime` datetime DEFAULT NULL COMMENT '评价时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

/*Data for the table `user_product_evaluate` */

insert  into `user_product_evaluate`(`id`,`userId`,`productId`,`uPEName`,`evaluateTime`) values (3,1,714,'便宜实惠','2018-08-08 21:40:40'),(5,1,715,'够冷的','2018-08-08 21:47:19'),(6,7,710,'好宝贝，++++++++','2018-08-09 15:21:42');
